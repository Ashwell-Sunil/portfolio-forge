...
export const defaultPortfolioData = {
  ...
  profile: {
    ...
    email: 'demo@foliovitae.io',
    github: 'https://github.com/sample-dev',
    linkedin: 'https://linkedin.com/in/sample-dev-eng',
    twitter: 'https://x.com/sampledev',
    resumeLink: 'https://example.com/sample-resume.pdf',
  ...
  projects: [
    {
      ...
      link: 'https://github.com/sample-dev/hypermesh',
      featured: true,
    },
    {
      id: 'proj-2',
      ...
      link: 'https://github.com/sample-dev/kubetelemetry',
      featured: true,
    },
    {
      id: 'proj-3',
      ...
      link: 'https://github.com/sample-dev/auradb',
      featured: false,
    },
  ],
  skills: [
